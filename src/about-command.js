export default function (context) {
    ...
    window.setIcon(NSImage.alloc().initByReferencingFile(context.plugin.urlForResourceNamed("window-icon.png").path()));
    ...
    if (result == 1001) {
        NSWorkspace.sharedWorkspace().openURL(NSURL.URLWithString("https://github.com/1217950746/Smile-Sketch"))
    }
}
